...
while (guests.length > 2) {
    var removeGuest = guests.shift();
    console.log(" ".concat(removeGuest, " I am sorry i can't invite you to dinner bacuase of unavaiability of table."));
}
console.log(guests);
// Message for 2 people 
var newMsg = guests.forEach(function (iguest) {
    console.log(" Dear ".concat(iguest, " , You are still Invited "));
});
