...
let cities : string[] = ["Karachi","Amsterdam","Vancouver","Ontario","Abu Dhabi"];

//Print your array in its original order.
console.log("original state:",cities);

//Print your array in alphabetical order without modifying the actual list.
let sortedArray :string[]  = cities.slice().sort();
console.log("Sorted Array with no change in original :",sortedArray);

// checking  array's original state
console.log("Checking original Array",cities);

// // Print your array in reverse alphabetical order without changing the order of the original list.
let reverse : string[] = cities.slice().reverse()  
